# 1. Realiza las siguientes operaciones aritmÃ©ticas:#   Suma: 15 + 25#   Resta: 50 - 22#   Multiplicación: 8 * 7#   División: 100 / 20

print(15 + 25) # int
print(50 - 22) # int
print(8 * 7) # int
print(100 / 20) # Float
# 2. Calcula el resto de la división de 37 entre 5 y almacenalo en una variable remainder. Luego imprimelo.
remainder = 37 % 5
print(remainder) # El resto es 2
# 3. Convierte el número 7 en una cadena de texto y concatenalo con la frase  es mi número favorito. Imprime el resultado.
print(str(7) + " Es mi número favorito")
# 4. Repite la palabra (Python) 10 veces usando el operador de multiplicación para cadenas y luego imprimela.
print("Python " * 10)
...
print("apple" > "banana") # Falseprint("apple" < "banana") # True lo ordena alfabeticamente 
...
print((5 * 3) + 2 > 10 or (5 * 3) + 2 < 20)
print(17 > 10 or 17 < 20)